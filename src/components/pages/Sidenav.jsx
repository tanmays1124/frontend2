        ...
        <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/dashboard")}}>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/bgraph")}}>
              ...
              >
                ...
                <ListItemText primary="BarGraph" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/lGraph")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary="LineGraph" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
        </List>
        <Divider />
